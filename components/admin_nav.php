  ...
  <aside id="sidebar" class="fixed top-16 left-0 w-64 bg-royal-blue-dark text-white shadow-lg transform transition-transform duration-300 ease-in-out z-10 pointer-events-auto overflow-y-auto" style="height: calc(100vh - 4rem);">
    <div class="p-4 relative">
      ...
      <nav class="space-y-2" aria-label="Sidebar Navigation">
        ...
        <a href="#" onclick="showSection('financial-analyst')" class="nav-item flex items-center p-3 rounded-lg hover:bg-royal-blue-light transition-colors duration-200">
          <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="#" onclick="showSection('statistician')" class="nav-item flex items-center p-3 rounded-lg hover:bg-royal-blue-light transition-colors duration-200">
          <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
